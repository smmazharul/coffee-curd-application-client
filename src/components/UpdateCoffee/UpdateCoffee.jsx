...
const UpdateCoffee = () => {
    ...
    // const [coffee,setCoffee]=useState(loadedCoffe)
    ...
    .then(data=>{
        ...
        if(data.modifiedCount>0){
          Swal.fire({
            title: 'Success',
            text: 'Successfully Updated a Coffee',
            icon: 'success',
    ...
    return (
        ...
        <div className="mt-12 bg-[#F4F3F0] p-4">
          ...
          <div className="text-center w-2/3 mx-auto">
              <h1 className="text-3xl text-[#374151] bold">Update a Coffee</h1>
          ...
          <form onSubmit={handleUpdate}>
            ...
            <input className="btn btn-block bg-[#D2B48C] bold" type="submit" value="Update a Coffee" />
            </div>
          </form>
        </div>
      </div>
